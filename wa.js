...
async function sendButtonMenu(sock, from, msg, senderJid, senderName, isOwner) {
  ...
  // ── IMAGE CAPTION (fancy fonts work here) ──
  const caption =
`╔══════════════════════════╗
║  🌹  *𝗥 𝗜 𝗔 𝗦  𝗔 𝗜*  🌹  ║
...
${F.bold('𝐇𝐞𝐲')} @${senderJid.split('@')[0]}! 👋 ${greet}!

${F.italic('I am RIAS — your intelligent, sassy and powerful WhatsApp companion.')}
...
_${F.italic('She does not beg for attention. She commands it.')} 🔴_`;
  ...
  const sections = [{
    ...
    rows: [
      {
        title: '🤖 ʀɪᴀs ᴀɪ sᴇᴄᴛɪᴏɴ',
        description: '✦ Gemini AI • Ask • Story • Roast • Translate',
        id: 'aimenu'
      },
      {
        title: '🎮 ɢᴀᴍᴇs sᴇᴄᴛɪᴏɴ',
        description: '✦ RPS • Slots • Guess • Trivia • Battle',
        id: 'gamemenu'
      },
      {
        title: '⚔️ ɢʀᴏᴜᴘ sᴇᴄᴛɪᴏɴ',
        description: '✦ Kick • Ban • Warn • Promote • Tag All',
        id: 'adminmenu'
      },
      {
        title: '📥 ᴅᴏᴡɴʟᴏᴀᴅ sᴇᴄᴛɪᴏɴ',
        description: '✦ Sticker • TTS • Lyrics • Short Link',
        id: 'downloadmenu'
      },
      {
        title: '💬 ᴅᴍ sᴇᴄᴛɪᴏɴ',
        description: '✦ Broadcast • Auto-Reply • Channel',
        id: 'dmmenu'
      },
      {
        title: '🎲 ꜰᴜɴ sᴇᴄᴛɪᴏɴ',
        description: '✦ Ship • Truth • Dare • Rank • Spirit',
        id: 'funmenu'
      },
      {
        title: '🛠️ ᴜᴛɪʟɪᴛʏ sᴇᴄᴛɪᴏɴ',
        description: '✦ Calc • Weather • Define • Time • Fact',
        id: 'utilitymenu'
      },
      {
        title: '🏅 sᴛᴀᴛs & ʟᴇᴠᴇʟs',
        description: '✦ XP • Leaderboard • Group Stats • Birthdays',
        id: 'statsmenu'
      },
      ...(isOwner ? [{
        title: '👑 ᴏᴡɴᴇʀ sᴇᴄᴛɪᴏɴ',
        description: '✦ Shutdown • Broadcast • Block • Controls',
        id: 'ownermenu'
      }] : []),
      {
        title: '📋 ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅs',
        description: '✦ See every single command in one place',
        id: 'allcmds'
      },
    ]
  }];
...
_Tap a section below to explore commands_ 👇`,
      footer: '🔴 RIAS AI • Jinx Official',
      title: '🌹 RIAS — Choose a Section',
